 ...
 401  0000               _TIM2_PrescalerConfig:
 ...
 420  0009 72105258      	bset	21080,#0
 422  000d 2004          	jra	L151
 423  000f               L741:
 424                     ; 291     TIM2->EGR &= (uint8_t)(~TIM_EGR_UG) ;
 426  000f 72115258      	bres	21080,#0
 427  0013               L151:
 428                     ; 293 }
 431  0013 81            	ret
 ...
 478  0000               _TIM2_CounterModeConfig:
 480  0000 88            	push	a
 481  0001 88            	push	a
 ...
 820  0003 72125250      	bset	21072,#1
 822  0007 2004          	jra	L713
 823  0009               L513:
 824                     ; 408     TIM2->CR1 &= (uint8_t)(~TIM_CR1_UDIS);
 826  0009 72135250      	bres	21072,#1
 827  000d               L713:
 828                     ; 410 }
 831  000d 81            	ret
 ...
 891  0000               _TIM2_UpdateRequestConfig:
 ...
 903  0004 72145250      	bset	21072,#2
 905  0008 2004          	jra	L153
 906  000a               L743:
 907                     ; 432     TIM2->CR1 &= (uint8_t)(~TIM_CR1_URS);
 909  000a 72155250      	bres	21072,#2
 910  000e               L153:
 911                     ; 434 }
 914  000e 81            	ret
 ...
 952  0000               _TIM2_ARRPreloadConfig:
 ...
 964  0003 721e5250      	bset	21072,#7
 966  0007 2004          	jra	L373
 967  0009               L173:
 968                     ; 454     TIM2->CR1 &= (uint8_t)(~TIM_CR1_ARPE);
 970  0009 721f5250      	bres	21072,#7
 971  000d               L373:
 972                     ; 456 }
 975  000d 81            	ret
...
1034  0000               _TIM2_SelectOnePulseMode:
...
1046  0004 72165250      	bset	21072,#3
1048  0008 2004          	jra	L524
1049  000a               L324:
1050                     ; 478     TIM2->CR1 &= (uint8_t)(~TIM_CR1_OPM);
1052  000a 72175250      	bres	21072,#3
1053  000e               L524:
1054                     ; 480 }
1057  000e 81            	ret
...
1106  0003 72105250      	bset	21072,#0
1108  0007 2004          	jra	L744
1109  0009               L544:
1110                     ; 500     TIM2->CR1 &= (uint8_t)(~TIM_CR1_CEN);
1112  0009 72115250      	bres	21072,#0
1113  000d               L744:
1114                     ; 502 }
1117  000d 81            	ret
...
1868  0000               _TIM2_CtrlPWMOutputs:
...
1880  0003 721e5265      	bset	21093,#7
1882  0007 2004          	jra	L7001
1883  0009               L5001:
1884                     ; 796     TIM2->BKR &= (uint8_t)(~TIM_BKR_MOE) ;
1886  0009 721f5265      	bres	21093,#7
1887  000d               L7001:
1888                     ; 798 }
1891  000d 81            	ret
...
2261  0000               _TIM2_ForcedOC2Config:
2263  0000 88            	push	a
2264  0001 88            	push	a
...
2335  0000               _TIM2_OC1PreloadConfig:
...
2396  0000               _TIM2_OC2PreloadConfig:
...
2577  0000               _TIM2_OC1PolarityConfig:
...
2638  0000               _TIM2_OC2PolarityConfig:
...
2950  0014 cd0000        	call	_TIM2_SetIC1Prescaler
...
2969  0028 cd0000        	call	_TIM2_SetIC2Prescaler
2971  002b               L7641:
2972                     ; 1209 }
2975  002b 85            	popw	x
2976  002c 81            	ret
...
3142  0031 cd0000        	call	_TIM2_SetIC1Prescaler
...
3158  0043 cd0000        	call	_TIM2_SetIC2Prescaler
...
3177  0057 cd0000        	call	_TIM2_SetIC2Prescaler
...
3193  0069 cd0000        	call	_TIM2_SetIC1Prescaler
3195  006c               L1551:
3196                     ; 1297 }
...
3445  0000               _TIM2_SetIC1Prescaler:
3447  0000 88            	push	a
3448  0001 88            	push	a
...
3528  0000               _TIM2_SetIC2Prescaler:
3530  0000 88            	push	a
3531  0001 88            	push	a
...
3670  0006 ca5255        	or	a,21077
3671  0009 c75255        	ld	21077,a
3673  000c 2009          	jra	L5371
3674  000e               L3371:
3675                     ; 1436     TIM2->IER &= (uint8_t)(~(uint8_t)TIM2_IT);
3677  000e 7b01          	ld	a,(OFST+1,sp)
3678  0010 43            	cpl	a
3679  0011 c45255        	and	a,21077
3680  0014 c75255        	ld	21077,a
3681  0017               L5371:
3682                     ; 1438 }
3685  0017 85            	popw	x
3686  0018 81            	ret
...
4295  0006 ca5254        	or	a,21076
4296  0009 c75254        	ld	21076,a
4298  000c 2009          	jra	L3122
4299  000e               L1122:
4300                     ; 1595     TIM2->DER &= (uint8_t)(~TIM2_DMASource);
4302  000e 7b01          	ld	a,(OFST+1,sp)
4303  0010 43            	cpl	a
4304  0011 c45254        	and	a,21076
4305  0014 c75254        	ld	21076,a
4306  0017               L3122:
4307                     ; 1597 }
4310  0017 85            	popw	x
4311  0018 81            	ret
...
4397  0000               _TIM2_InternalClockConfig:
4401                     ; 1647   TIM2->SMCR &=  (uint8_t)(~TIM_SMCR_SMS);
4403  0000 c65252        	ld	a,21074
4404  0003 a4f8          	and	a,#248
4405  0005 c75252        	ld	21074,a
4406                     ; 1648 }
4409  0008 81            	ret
...
4500  0000               _TIM2_TIxExternalClockConfig:
...
4544  0023 cd0000        	call	_TIM2_SelectInputTrigger
4546                     ; 1688   TIM2->SMCR |= (uint8_t)(TIM2_SlaveMode_External1);
4548  0026 c65252        	ld	a,21074
...
4674  0000               _TIM2_ETRClockMode1Config:
...
4775  0000               _TIM2_ETRClockMode2Config:
...
4789  0009 cd0000        	call	_TIM2_ETRConfig
4791  000c 84            	pop	a
4792                     ; 1747   TIM2->ETR |= TIM_ETR_ECE ;
4794  000d 721c5253      	bset	21075,#6
4795                     ; 1748 }
4798  0011 85            	popw	x
4799  0012 81            	ret
...
4917  0000               _TIM2_SelectInputTrigger:
4919  0000 88            	push	a
4920  0001 88            	push	a
...
5054  0000               _TIM2_SelectOutputTrigger:
5056  0000 88            	push	a
5057  0001 88            	push	a
...
5175  0000               _TIM2_SelectSlaveMode:
5177  0000 88            	push	a
5178  0001 88            	push	a
...
5249  0000               _TIM2_SelectMasterSlaveMode:
...
5347  0006 ca5253        	or	a,21075
5348  0009 c75253        	ld	21075,a
5349                     ; 1923 }
5352  000c 85            	popw	x
5353  000d 81            	ret
...
5468  0000               _TIM2_EncoderInterfaceConfig:
...
5622  0000               _TIM2_SelectHallSensor:
...
5746  000a 7211525b      	bres	21083,#0
